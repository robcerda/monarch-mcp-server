...
def set_budget_amount(
    ...
    """
    try:
        # Validate that exactly one of category_id or category_group_id is provided
        ...
        async def _set_budget():
            ...
            return await client.set_budget_amount(**params)
...
def get_spending_summary(
    ...
    try:
        ...
        async def _get_summary():
            ...
            return await client.get_cashflow_summary(**params)

        result = run_async(_get_summary())

        # Format the summary for easier reading
        ...
        # Sort by absolute amount (highest spending first)
